...
INSERT INTO Bibliotheque (Nom, Description, DateCreation, Categorie)
VALUES
...
INSERT INTO MiseAJour (Version, DescMiseAJour, IdBibliotheque)
VALUES 
...
INSERT INTO Critique (Date, Message, Rating, NomUtilisateur, IdBibliotheque)
VALUES 
...
INSERT INTO Fonction (Nom, Description, NombreLignesDeCode, DernierUpdate, IdBibliotheque)
VALUES 
...
INSERT INTO ReglageConfig (Theme, nomMembre, langPref, notificationAct)
VALUES 
...
WHILE @i <= 40
BEGIN
    INSERT INTO UtilisateurBibliotheque (IdUtilisateur, IdBibliotheque, DateTelechargement)
